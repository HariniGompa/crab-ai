...
import { Shell, Mail, Lock, Eye, EyeOff, KeyRound, CheckCircle, User, Target, FileEdit, Sparkles, Check, X } from "lucide-react";
        ...
        <div className="w-full max-w-sm">
          ...
          {step === "otp" && (
            <>
              ...
              <h1 className="text-xl font-bold text-center mb-1">Verify your email</h1>
              <p className="text-muted-foreground text-center mb-6 text-sm">
